...
#ifdef BACKSLICE
void runBackProjectKernel_slice(
		AccBackprojector &BP,
		AccProjectorKernel &projector,
		XFLOAT *d_img_real,
		XFLOAT *d_img_imag,
...
/*				cuda_kernel_backproject3D<false><<<imageCount,BP_REF3D_BLOCK_SIZE,0,optStream>>>(
					...
					imgX, imgY, imgZ, imgX*imgY*imgZ,
					BP.mdlX, BP.mdlY, BP.mdlInitY, 	BP.mdlInitZ);*/
				cuda_kernel_backproject3D_slice<false><<<1,BP_REF3D_BLOCK_SIZE_SLICE,0,optStream>>>(
					d_img_real, d_img_imag,
					trans_x, trans_y, trans_z,
					d_weights, d_Minvsigma2s, d_ctfs,
					translation_num, significant_weight, weight_norm,
					d_eulers,BP.d_index,BP.d_real,BP.d_imag,BP.d_weight,
					BP.maxR, BP.maxR2, BP.padding_factor,
					imgX, imgY, imgZ, imgX*imgY*imgZ,
					BP.mdlX, BP.mdlY, BP.mdlInitY, 	BP.mdlInitZ,imageNum,flagptr);
#endif
...
#ifdef FILTERSLICE
void runBackProjectKernel_filterslice(
		AccBackprojector &BP,
		AccProjectorKernel &projector,
		XFLOAT *d_img_real,
		XFLOAT *d_img_imag,
...
/*				cuda_kernel_backproject3D<false><<<imageCount,BP_REF3D_BLOCK_SIZE,0,optStream>>>(
					...
					imgX, imgY, imgZ, imgX*imgY*imgZ,
					BP.mdlX, BP.mdlY, BP.mdlInitY, 	BP.mdlInitZ);*/
				cuda_kernel_backproject3D_filterslice<false><<<1,BP_REF3D_BLOCK_SIZE_SLICE,0,optStream>>>(
					d_img_real, d_img_imag,
					trans_x, trans_y, trans_z,
					d_weights, d_Minvsigma2s, d_ctfs,
					translation_num, significant_weight, weight_norm,
					d_eulers,BP.d_index,BP.d_real,BP.d_imag,BP.d_weight,
					BP.d_count,
					BP.d_filterreal,BP.d_filterimag,BP.d_filterweight,
					BP.maxR, BP.maxR2, BP.padding_factor,
					imgX, imgY, imgZ, imgX*imgY*imgZ,
					BP.mdlX, BP.mdlY, BP.mdlInitY, 	BP.mdlInitZ,imageNum,flagptr,BP.fxsize,BP.fysize,BP.fzsize,
					BP.fstartx,BP.fstarty,BP.fstartz,BP.fendx,BP.fendy,BP.fendz);
/*
				int flagcpu[1];
				cudaMemcpy(flagcpu,flagptr,sizeof(int)*1,cudaMemcpyDeviceToHost);
				if(flagcpu[0]!=0)
					cuda_kernel_backproject3D_sortbykey(BP.d_index,BP.d_real,BP.d_imag,BP.d_weight,BP.d_count,imgX*imgY*8,countnum);
*/
