...
#endif
#ifdef COMFORGPU
			,size_t sumalldata,size_t *d_yoffsetdata
#endif
			):
...
#ifdef COMFORGPU
	,sumalldata(sumalldata),d_yoffsetdata(d_yoffsetdata)
#endif
		{
#ifdef COMFORGPU
		datarange = (maxR+2)*(maxR+2)*4;
#endif
		};
...
#ifdef CUDA
#ifdef COMFORGPU
		real = no_tex3D_compress(mdlReal, xp, yp, zp, mdlX, mdlXY, mdlInitY, mdlInitZ,datarange,d_yoffsetdata,mdlZ);
		imag = no_tex3D_compress(mdlImag, xp, yp, zp, mdlX, mdlXY, mdlInitY, mdlInitZ,datarange,d_yoffsetdata,mdlZ);
#else
