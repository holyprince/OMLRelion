...
public:
	...
	void rawinitialiseDataAndWeight(int current_size = -1);
	//add by wzh
	...
	*/
	...
	void reconstruct_gpu_transpose(MultidimArray<RFLOAT> &vol_out,
                     ...
                     bool printTimes= false,
					 bool do_fsc0999 = false);
	void reconstruct_gpu_transpose_test(MultidimArray<RFLOAT> &vol_out,
	                     int max_iter_preweight,
	                     bool do_map,
	                     RFLOAT tau2_fudge,
	                     MultidimArray<RFLOAT> &tau2_io,
	                     ...
	                     bool printTimes= false,
						 bool do_fsc0999 = false);
	void reconstruct_gpumpi(MultidimArray<RFLOAT> &vol_out,
                     int max_iter_preweight,
                     bool do_map,
                     RFLOAT tau2_fudge,
                     MultidimArray<RFLOAT> &tau2_io,
	...
	void reconstruct_gpumpicard(MultidimArray<RFLOAT> &vol_out,
                     int max_iter_preweight,
                     bool do_map,
                     RFLOAT tau2_fudge,
                     MultidimArray<RFLOAT> &tau2_io,
					 ...
					 int realranknum = 0,
					 int ranksize = 1);
	void reconstruct_test(MultidimArray<RFLOAT> &vol_out,
                     int max_iter_preweight,
                     bool do_map,
                     RFLOAT tau2_fudge,
                     MultidimArray<RFLOAT> &tau2_io,
