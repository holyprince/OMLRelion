...
#include "../gpu_utils/cuda_settings.h"
...
// resulting in warnings. This avoids those warnings.
	...
	#undef CubLog
#endif
#include "../gpu_utils/cub/device/device_radix_sort.cuh"
#include "../gpu_utils/cub/device/device_reduce.cuh"
#include "../gpu_utils/cub/device/device_scan.cuh"
#include "../gpu_utils/cub/device/device_select.cuh"
